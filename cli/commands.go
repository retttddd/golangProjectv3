...
var set = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		srv := service.New(service.NewFsStorage(), service.NewAESEncoder(de_encoding.PassToSecretKey(args[2])))
...
var get = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		srv := service.New(service.NewFsStorage(), service.NewAESEncoder(de_encoding.PassToSecretKey(args[1])))
